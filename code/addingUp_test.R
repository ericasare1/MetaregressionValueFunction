...
adding_up_pred <- data.frame((predictInterval(merMod = Model_1b, newdata = adding_up_testdata,
...
#Adding up: Model 2
adding_up_pred_model2 <- data.frame((predictInterval(merMod = Model_2c, newdata = adding_up_testdata,
                                                     level = 0.95, n.sims = 1000,
